...
public interface PermissionPersistence extends JpaRepository<PermissaoLinhaPup, Long>{
	...
	@Override
	public List<OrderDto> search(String max_total, String min_total, String pstatus, String q) throws AbstractBusinessException {
		try {
...
//			String status=orderDto.getStatus()==null?"%":orderDto.getStatus().toString();
			...
			List<Order> orderDb = orderRepository.findBySearchv2(max_total, min_total,status);
